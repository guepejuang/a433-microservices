...
docker tag karsajobs:latest docker.pkg.github.com/guepejuang/a433-microservices/karsajobs:latest
...
docker push docker.pkg.github.com/guepejuang/a433-microservices/karsajobs:latest
